            ...
            <tbody>
              {services.map((service: any) => (
                <tr key={service.id} className="border-b border-primary/10 hover:bg-primary/5">
                  <td className="px-6 py-4 font-medium whitespace-nowrap">{isEn ? service.title_en : service.title_ar}</td>
                  <td className="px-6 py-4 text-muted-foreground whitespace-nowrap">{service.sort_order}</td>
